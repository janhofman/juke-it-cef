...
public:
	...
	~FileServerHandler() {} ;
	// interface methods
	virtual ResponseCode v1_Songs(std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Song(const std::string& songId, web::json::value& response) override;
	virtual ResponseCode v1_Albums(std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Album(const std::string& albumId, web::json::value& response) override;
	virtual ResponseCode v1_AlbumSongs(const std::string& albumId, std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Artists(std::uint32_t limit, std::uint32_t start, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Artist(const std::string& artistId, web::json::value& response) override;
	virtual ResponseCode v1_ArtistSongs(const std::string& artistId, std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Genres(std::uint32_t limit, std::uint32_t start, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Genre(const std::string& genreId, web::json::value& response) override;
	virtual ResponseCode v1_GenreSongs(const std::string& genreId, std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	virtual ResponseCode v1_Playlists(const std::string& userId, std::uint32_t limit, std::uint32_t start, bool desc, const std::string& filter, web::json::value& response) override;
	...
	virtual ResponseCode v1_PlaylistSongs(const std::string& userId, const std::string& playlistId, std::uint32_t limit, std::uint32_t start, const std::string& orderBy, bool desc, const std::string& filter, web::json::value& response) override;
	...
	virtual ResponseCode v1_Ping() override;
